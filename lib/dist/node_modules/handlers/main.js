...
var MongoDoc, Report, Seq, _, cache, cursor2JsonArray, getReport, handleError, helpers, json2Csv, logger, main, sendReport, sendReportList, truncate, util;
...
main = function(app, config) {
  var outputCacheTimeout;
  outputCacheTimeout = (config != null ? config.outputCacheTimeout : void 0) || 0;
  ...
  app.get("/report/output/:_id/:name", cache.middleware("1 minute"), function(req, res) {
    var report;
    report = new Report({
      _id: req.params._id
    });
