...
window.JSEditor = React.createClass({displayName: "JSEditor",
  ...
  componentDidMount: function() {
    ...
    this.contentDidChangeDebounced = _.debounce(this.contentDidChangeDebounced, 1500);
      ...
      switch (this.props.type) {
        case "aggregate":
          React.createElement("a", {
            "href": "https://docs.mongodb.org/v4.0/meta/aggregation-quick-reference/",
            "target": "_blank"
          }, " Aggregation quick reference");
          return React.createElement("a", {
            "href": "https://docs.mongodb.org/v4.0/reference/operator/query/",
            "target": "_blank"
...
window.ModeSelector = React.createClass({displayName: "ModeSelector",
  render: function() {
    return React.createElement("div", {
    ...
    }, "\t\t\t\t\t\tmax docs", React.createElement("input", {
      "id": "maxDocs",
      "type": "number",
      "defaultValue": "10",
      "min": "1",
      ...
      "onChange": this.maxDocsDidChange,
      "ref": "maxDocs"
    }))), React.createElement("div", {
  ...
  maxDocsDidChange: function(e) {
    var maxDocs;
    maxDocs = parseInt($(this.refs.maxDocs).val(), 10);
    e = $.Event("didUpdateMaxDocs", {
      reportId: this.props.report._id,
      maxDocs: maxDocs
    });
    return $("body").trigger(e);
